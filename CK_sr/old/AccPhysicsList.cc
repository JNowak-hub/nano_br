...
#include "AccMaxTimeCuts.hh"
#include "AccMinEkineCuts.hh"
...
// Constructor /////////////////////////////////////////////////////////////
AccPhysicsList::AccPhysicsList() : G4VUserPhysicsList() 
{
...
// Destructor //////////////////////////////////////////////////////////////
AccPhysicsList::~AccPhysicsList() 
{;}

// Construct Particles /////////////////////////////////////////////////////
void AccPhysicsList::ConstructParticle() 
{
...
// construct Bosons://///////////////////////////////////////////////////
void AccPhysicsList::ConstructMyBosons()
{
  // pseudo-particles
...
// construct Leptons://///////////////////////////////////////////////////
void AccPhysicsList::ConstructMyLeptons()
{
  // leptons
...
// construct Hadrons://///////////////////////////////////////////////////
void AccPhysicsList::ConstructMyHadrons()
{
 //  mesons
...
void AccPhysicsList::ConstructMyShortLiveds()
{
...
// Construct Processes //////////////////////////////////////////////////////
void AccPhysicsList::ConstructProcess() 
{
  AddTransportation();
...
// Transportation ///////////////////////////////////////////////////////////
void AccPhysicsList::AddTransportation() {
  ...
  while( (*particleIterator)() ){
    ...
    if(particleName == "neutron") 
      pmanager->AddDiscreteProcess(new AccMaxTimeCuts());
    // Energy cuts to kill charged (embedded in method) particles:
    pmanager->AddDiscreteProcess(new AccMinEkineCuts());
...
void AccPhysicsList::ConstructEM() {
...
// Optical Processes ////////////////////////////////////////////////////////
void AccPhysicsList::ConstructOp() 
{
...
void AccPhysicsList::ConstructHad() 
{
  //Elastic models
...
// Decays ///////////////////////////////////////////////////////////////////
void AccPhysicsList::ConstructGeneral() {
...
// Cuts /////////////////////////////////////////////////////////////////////
void AccPhysicsList::SetCuts() 
{
  
  if (verboseLevel >1)
    G4cout << "AccPhysicsList::SetCuts:";
