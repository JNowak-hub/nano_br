...
AccMaxTimeCuts::AccMaxTimeCuts(const G4String& aName)
...
AccMaxTimeCuts::AccMaxTimeCuts(AccMaxTimeCuts&)
 : AccSpecialCuts()
{}

 
G4double AccMaxTimeCuts::PostStepGetPhysicalInteractionLength(
