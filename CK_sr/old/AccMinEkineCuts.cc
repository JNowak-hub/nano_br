...
AccMinEkineCuts::AccMinEkineCuts(const G4String& aName)
  : AccSpecialCuts(aName)
{
    if (verboseLevel>1) {
...
AccMinEkineCuts::AccMinEkineCuts(AccMinEkineCuts&)
  : AccSpecialCuts()
{}


G4double AccMinEkineCuts::PostStepGetPhysicalInteractionLength(
